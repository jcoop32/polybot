...
CSV_FILE = "csv_logs/paper_trades_10_v2.csv"
CSV_FILE_NOREINVEST = "csv_logs/paper_trades_10_noreinvest_v2.csv"
...
def build_screen(state: dict) -> str:
    ...
    no_reinvest = state.get("no_reinvest", False)
...
async def simulate_candle(
    ...
    while True:
        ...
        update_ui(market=market, remaining=300, candle_open=0,
                  stats=stats, trade_window=trade_window, no_reinvest=no_reinvest)
